		    ...
		    <div class="container">
			    ...
			    <div class="item mb-5">
				    <div class="media">
					    ...
					    <div class="media-body">
						    <h3 class="title mb-1"><a href="./modificaAssociazione.php">CAMBIA IL MEDICO DI UN PAZIENTE</a></h3>
                        </div><!--//media-body-->
				    </div><!--//media-->
			    </div><!--//item-->
			    <div class="item mb-5">
				    <div class="media">
					    ...
					    <div class="media-body">
						    <h3 class="title mb-1"><a href="./rimuoviPaziente.php">ELIMINA UN DETERMINATO PAZIENTE</a></h3>
                        </div><!--//media-body-->
				    </div><!--//media-->
			    </div><!--//item-->
            </div>
